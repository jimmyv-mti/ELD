...
import com.android.eldbox.MainActivity;
 ...
 * @ClassName: SerialUIMainActivity
 ...
 * @Version: 1.0
 */
public class SerialUIMainActivity extends AppCompatActivity {
    ...
    //Debug
    private static final String TAG = "SerialUIMainActivity";
    ...
    static final String ACTION_BROADCAST = "com.android.eldbox.broadcast";
    static final String EXTRA_LOCATION = "com.android.eldbox.location";
    private static final String EXTRA_STARTED_FROM_NOTIFICATION = "com.android.eldbox.started_from_notification";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(SerialUIMainActivity.this, android.R.layout.simple_list_item_1, data);
        ...
        result.addOnCompleteListener(new OnCompleteListener<LocationSettingsResponse>() {
            ...
            public void onComplete(@NonNull Task<LocationSettingsResponse> task) {
                ...
                try {
                    ...
                    Toast.makeText(SerialUIMainActivity.this, "GPS is already tured on", Toast.LENGTH_SHORT).show();
                    ...
                    switch (e.getStatusCode()) {
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            ...
                            try {
                                ...
                                resolvableApiException.startResolutionForResult(SerialUIMainActivity.this, 2);
    ...
    private void getCurrentLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(SerialUIMainActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {

            if (isGPSEnabled()) {

                LocationServices.getFusedLocationProviderClient(SerialUIMainActivity.this)
    ...
    private Notification getNotification() {
        Intent intent = new Intent(this, SerialUIMainActivity.class);
        ...
        Notification.Builder builder = new Notification.Builder(this)
                .addAction(R.drawable.ic_launcher_background, getString(R.string._cancel),
                        activityPendingIntent)
                .addAction(R.drawable.ic_launcher_background, getString(R.string._connect),
    ...
    static String getLocationTitle(Context context) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            return context.getString(R.string.common_google_play_services_update_text,
    ...
    private void init() {
        ...
        gotoSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SerialUIMainActivity.this, SerialSettingsActivity.class));
            }
        });
        ...
        mIvDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialog = new AlertDialog.Builder(SerialUIMainActivity.this).setTitle(R.string.listview_dialog_title)
                ...
                public void run() {
                    ...
                    while (true) {
                        ...
                        try {
                            ...
                            */
                            ((MApplication) getApplication()).serialAgent.requestFuelLevel();
                            Thread.sleep(30000);
                        } catch (IOException e) {
                            e.printStackTrace();
                ...
                .request(new OnPermission() {
                    ...
                    public void noPermission(List<String> denied, boolean quick) {
                        if (quick) {
                            ...
                            XXPermissions.gotoPermissionSettings(SerialUIMainActivity.this);
                        } else {
    ...
    private void SyncTimeFromTablet() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                Looper.prepare();
                try {
                    ((MApplication) getApplication()).serialAgent.requestTimeSync(System.currentTimeMillis());
                    Thread.sleep(100);
                    ((MApplication) getApplication()).serialAgent.requestVersion();
                    hasSyncTime = true;
    ...
    private void SyncTimeWhenConnectNetwork() {
        if (!NetUtils.isConnected(SerialUIMainActivity.this)) {//no network
            if (needOpenWifiSettings && !hasSyncTime) {
                needOpenWifiSettings = false;//hjh 20190921 for user click cancel
                openSetting(SerialUIMainActivity.this);
            }
        } else {//has network
    ...
    class NTPThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                ((MApplication) getApplication()).serialAgent.requestTimeSync(waitToSyncTime);
    ...
    BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            switch (Objects.requireNonNull(intent.getAction())) {
                ...
                case SerialUIMainActivity.ACTION_GATT_CONNECTED: {
    ...
    EldboxCallBack mEldboxCallBack = new EldboxCallBack() {
        ...
        public void onReceiveVin(long timeStamp, final String vin) {
            ...
            DBUtils.insert_VIN_inSMB(getApplication(), vin, SerialSettingsActivity.sTimestamp_inSMB);
        }
        ...
        public void onReceiveHighPrecisionOdometer(long timeStamp, final long highPrecisionOdometer) {
            ...
            if (highPrecisionOdometer != 0) {
                Intent intent = new Intent(SerialSettingsActivity.sHighPrecisionOdometerIntent);
                intent.putExtra(SerialSettingsActivity.sHighPrecisionOdometerIntentData, highPrecisionOdometer);
        ...
        public void onReceiveResponse(int responseType, byte[] response) {
            Intent intent = new Intent(SerialSettingsActivity.sResponseIntent);
            intent.putExtra(SerialSettingsActivity.sResponseIntentType, responseType);
            intent.putExtra(SerialSettingsActivity.sResponseIntentData, response);
            sendBroadcast(intent);

            Intent gpioIntent = new Intent(SerialGpioActivity.sGpioDataIntent);
            gpioIntent.putExtra(SerialGpioActivity.sGpioDataIntentType, responseType);
            gpioIntent.putExtra(SerialGpioActivity.sGpioDataIntentData, response);
